...
final List<Person> peopleList = _people
    .map((e) => Person(
          ...
          age: e['age'].toString(),
          eyeColor: e['eyeColor'].toString(),
          gender: e['gender'].toString(),
          company: e['company'].toString(),
          address: e['address'].toString(),
          about: e['about'].toString(),
          email: e['email'].toString(),
          registered: e['registered'].toString(),
          greeting: e['greeting'].toString(),
          favoriteFruit: e['favoriteFruit'].toString(),
        ))
